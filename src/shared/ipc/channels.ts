export const IPC_CHANNELS = {
  ...
  DATA_TRANSFER_VALIDATE_TRANSPORT: 'data_transfer:validate_transport',
  DATA_TRANSFER_TRANSPORT: 'data_transfer:transport',
  DATA_TRANSFER_TRANSPORT_PROGRESS: 'data_transfer:transport_progress',
